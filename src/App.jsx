...
<header className="navbar">
  ...
  <nav className={`nav-links ${isMobileMenuOpen ? "show" : ""}`}>
    ...
    <button onClick={() => { setCurrentView("home"); setIsMobileMenuOpen(false); }}
      className={`nav-button ${currentView === "home" ? "active" : ""}`} type="button">Home</button>

    <button onClick={() => { setCurrentView("shipping"); setIsMobileMenuOpen(false); }}
      className={`nav-button ${currentView === "shipping" ? "active" : ""}`} type="button">Shipping</button>

    <button onClick={() => { setCurrentView("mailbox"); setIsMobileMenuOpen(false); }}
      className={`nav-button ${currentView === "mailbox" ? "active" : ""}`} type="button">Mail Box</button>

    <button onClick={() => { setCurrentView("personalShopper"); setIsMobileMenuOpen(false); }}
      className={`nav-button ${currentView === "personalShopper" ? "active" : ""}`} type="button">Personal Shopper</button>

    <button onClick={() => { setCurrentView("myFoods"); setIsMobileMenuOpen(false); }}
      className={`nav-button ${currentView === "myFoods" ? "active" : ""}`} type="button">My Foods</button>
    ...
    <button onClick={() => { setCurrentView("account"); setIsMobileMenuOpen(false); }}
      className={`nav-button ${currentView === "account" ? "active" : ""}`} type="button">
